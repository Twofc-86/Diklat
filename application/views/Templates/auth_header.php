...
<head>
    ...
    <link rel="icon" type="image/png" href="<?= base_url('assets/'); ?>img/Lorem.png">
    <title>
        Train
    </title>
    <!--Fonts and icons-->
    ...
    <link href="<?= base_url('assets/'); ?>css/nucleo-svg.css" rel="stylesheet" />
    <!--CSS Files-->
    <link href="<?= base_url('assets/'); ?>css/Homemade.css" rel="stylesheet" />
    <link href="<?= base_url('assets/'); ?>scss/bootstrap-4.scss" rel="stylesheet" />
    <link href="<?= base_url('assets/'); ?>scss/style-login.scss" rel="stylesheet" />
    <link href="<?= base_url('assets/'); ?>scss/carousel.scss" rel="stylesheet" />
    <link href="<?= base_url('assets/'); ?>css/Custom.css" rel="stylesheet" />
    <link rel="stylesheet" href="<?php echo base_url('assets/vendor') ?>/plugins/datatables-bs4/css/dataTables.bootstrap4.min.css">
    <link rel="stylesheet" href="<?php echo base_url('assets/vendor') ?>/plugins/datatables-responsive/css/responsive.bootstrap4.min.css">
    <link rel="stylesheet" href="<?php echo base_url('assets/vendor') ?>/plugins/datatables-buttons/css/buttons.bootstrap4.min.css">
    ...
    <script src="<?= base_url('assets/'); ?>js/core/carousel.js"></script>
    <script src="<?= base_url('assets/'); ?>js/core/util.js"></script>
    <script src="<?= base_url('assets/'); ?>js/core/bootstrap.min.js"></script>
    <script src="<?= base_url('assets/'); ?>js/plugins/perfect-scrollbar.min.js"></script>
    <script src="<?= base_url('assets/'); ?>js/plugins/smooth-scrollbar.min.js"></script>
    <script src="<?= base_url('assets/'); ?>jquery/jquery.min.js"></script>
    <script src="<?= base_url('assets/'); ?>jquery-easing/jquery.easing.min.js"></script>
    <script src="<?= base_url('assets/'); ?>js/core/Homemade.js"></script>
    <script src="<?= base_url('assets/'); ?>js/core/Custom.js"></script>
    <script defer src="https://static.cloudflareinsights.com/beacon.min.js/vaafb692b2aea4879b33c060e79fe94621666317369993" integrity="sha512-0ahDYl866UMhKuYcW078ScMalXqtFJggm7TmlUtp0UlD4eQk0Ixfnm5ykXKvGJNFjLMoortdseTfsRT8oCfgGA==" data-cf-beacon='{"rayId":"77f685e2aef67e76","token":"cd0b4b3a733644fc843ef0b185f98241","version":"2022.11.3","si":100}' crossorigin="anonymous"></script>
    <script src="//cdn.jsdelivr.net/npm/sweetalert2@11"></script>

    <!-- Bootstrap 4
    <script src="<?php echo base_url('assets/vendor') ?>/plugins/bootstrap/js/bootstrap.bundle.min.js"></script> -->
